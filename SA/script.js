...
const start_game = () => {
	document.querySelector("#start_puzzle").style.display = "None";
	document.querySelector("#Puzzle_box").style.display = "";
...
answer_delay_slider.oninput = () => {
	document.querySelector('#Answer_delay_show').innerHTML = `Answer Delay: ${answer_delay_slider.value}s`
}